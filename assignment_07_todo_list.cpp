...
void addTask(vector<string>& tasks) {
    ...
    // Clear newline leftover in input buffer if needed
    cin.ignore();
...
// Option 3: Delete a task by its 1-based number
void deleteTask(vector<string>& tasks) {
    ...
    // Validate if the number corresponds to an existing task (1-based index)
